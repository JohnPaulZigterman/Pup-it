...
export const motionFeelCatalog = [
  {
    id: "smooth",
    name: "Smooth TV",
    description: "Balanced screen acting with gentle starts, clean stops, and light body life.",
    speed: 1.22,
    acceleration: 0.74,
    depthAcceleration: 0.66,
    deceleration: 0.86,
    depthDeceleration: 0.8,
    reversal: 2.15,
    deadzone: 0.06,
    lean: 3.8,
    maxLean: 6,
  ...
  },
  {
    id: "direct",
    name: "Snappy Cutout",
    description: "Fast blocking, crisp reversals, and flatter handmade cutout movement.",
    speed: 1.22,
    acceleration: 0.82,
    depthAcceleration: 0.68,
    deceleration: 0.9,
    depthDeceleration: 0.82,
    reversal: 2.25,
    deadzone: 0.08,
    lean: 2.2,
    maxLean: 3.5,
  ...
  },
  {
    id: "loose",
    name: "Loose Puppet",
    description: "Handmade drift with extra follow-through and funny puppet weight.",
    speed: 1.08,
    acceleration: 0.4,
    depthAcceleration: 0.34,
    deceleration: 0.52,
    depthDeceleration: 0.46,
    reversal: 1.9,
    deadzone: 0.07,
    lean: 6.2,
    maxLean: 8,
  ...
  },
  {
    id: "slow",
    name: "Slow Awkward",
    description: "Patient, uncomfortable movement for documentary pauses and dead air.",
    speed: 0.82,
    acceleration: 0.28,
    depthAcceleration: 0.22,
    deceleration: 0.4,
    depthDeceleration: 0.34,
    reversal: 1.6,
    deadzone: 0.08,
    lean: 3.2,
    maxLean: 4.5,
  ...
  },
  {
    id: "floaty",
    name: "Floaty Weird",
    description: "Soft surreal gliding with delayed weight and dreamy follow-through.",
    speed: 0.92,
    acceleration: 0.2,
    depthAcceleration: 0.18,
    deceleration: 0.3,
    depthDeceleration: 0.28,
    reversal: 1.48,
    deadzone: 0.06,
    lean: 5.2,
    maxLean: 7,
...
export const mutationRecipeCatalog = [
  {
    ...
    bodies: ["sliver", "kite", "panel", "stack", "triangle"],
  ...
  },
  {
    ...
    bodies: ["narrow", "capsule", "plank", "blob"],
  ...
  },
  {
    ...
    bodies: ["capsule", "narrow", "stack", "tall"],
  ...
  },
  {
    ...
    bodies: ["plank", "panel", "kite", "triangle"],
    limbs: ["hinged", "stick"],
    walkCycles: ["stiff", "rubber"],
